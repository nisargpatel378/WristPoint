...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-ui-border-base w-full">
      <div className="content-container max-w-lg sm:mx-auto sm:text-center relative flex w-full pr-20 mt-8">
        <Image
          className="rounded-3xl mx-4"
          src={require("../../../../../../wristpoint-storefront/public/logo.png")}
          alt=""
          unoptimized
          height={50}
        ></Image>
        <p className="leading-relaxed mt-2 text-[15px]">
          Discover Your Perfect Timepiece at Wrist Point.
        </p>
      </div>
      <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0 hidden">
        <LocalizedClientLink
          href="/"
          className="txt-compact-xlarge-plus hover:text-ui-fg-base text-slate-400 font-normal"
      ...
      <div className="mt-8 items-center justify-between sm:flex mb-8 ml-8">
        <div className="mt-4 sm:mt-0">
          &copy; 2024 WristPoint All rights reserved.
        </div>
        <div className="mt-6 sm:mt-0 mr-8">
